module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    uglify: {
      build: {
        src: ['js/vendor/dependencies/jquery.min.js', 'js/vendor/dependencies/jquery-ui.min.js', 'js/vendor/dependencies/angular.min.js', 'js/vendor/dependencies/raphael.min.js', 'js/vendor/dependencies/*.js', 'js/app/app.js', 'js/app/services/*.js', 'js/app/directives/*.js', 'js/app/controllers/*.js'],
